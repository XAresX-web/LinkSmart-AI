...
export function BackupManager({
  ...
  const downloadBackup = (backup: Backup) => {
    ...
    link.href = url;
    link.download = `enlacehub-backup-${
      new Date(backup.created_at).toISOString().split("T")[0]
    }.json`;
      ...
      <Card className="border-0 shadow-md">
        ...
        <CardContent className="text-center p-8">
          ...
          <p className="text-gray-600 mb-6">
            Mantén tus datos seguros con backups automáticos y restauración
            instantánea
          </p>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Mantén tus datos seguros con backups regulares
              </CardDescription>
            </div>
            <Button
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span>
                  {creating ? "Creando backup..." : "Restaurando datos..."}
                </span>
                <span>{progress}%</span>
              </div>
      ...
      <Card className="border-0 shadow-md">
        ...
        <CardContent>
          <Alert>
            ...
            <AlertDescription>
              Los backups automáticos están activados. Se crean diariamente a
              las 2:00 AM UTC.
            </AlertDescription>
          </Alert>
        </CardContent>
